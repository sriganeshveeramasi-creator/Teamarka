  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome-msg',
      sender: 'arka',
      text: "Hello! I am ARKA AI, your specialized logistics & accessibility assistant for Northeast India. You can ask me about routes, traffic, weather, road risks, tolls, shipments, or nearby emergency facilities.",
      time: 'Just now',
      response: {
        id: 'welcome-resp',
        intent: 'unknown',
