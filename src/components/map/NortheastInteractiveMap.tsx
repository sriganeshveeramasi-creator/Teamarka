...
export type { NortheastInteractiveMapProps };
...
export function SvgNortheastMap({
  highlightRoute = true,
  ...
  return (
    <div className={`relative w-full ${heightClass} bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 rounded-2xl overflow-hidden border border-slate-700 shadow-md text-slate-100 select-none flex flex-col`}>
      ...
      >
        ...
        {activeShipmentPoint && activeShipmentPoint.x !== undefined && activeShipmentPoint.y !== undefined && (
        ...
        {focusedPoint && focusedPoint.x !== undefined && focusedPoint.y !== undefined && (
          <g filter="url(#route-glow)">
            <circle
              cx={focusedPoint.x}
              cy={focusedPoint.y}
